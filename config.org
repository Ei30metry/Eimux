...
#+begin_src emacs-lisp
  ...
  (setq display-buffer-alist
        '(
          ((or . ((derived-mode . helpful-mode)
                 ...
                 "\\*\\(Help\\|haskell-compilation\\|compilation\\|sly-description\\|sly-macroexpansion\\)\\*"))
  ...
  REPL </>\\|Racket Describe </>\\|Racket Logger </>\\|Tex Help\\|idris2-repl\\)\\*"))
           (display-buffer-reuse-mode-window
            display-buffer-below-selected)
            (window-height . 22)
            (body-function . select-window))
...
#+begin_src emacs-lisp
;; (use-package flymake-flycheck :straight t :after dante)
#+end_src
** helpful
#+begin_src emacs-lisp
(use-package helpful
...
** zzz-to-char
#+begin_src emacs-lisp
(use-package zzz-to-char :straight t :bind ("M-z" . zzz-to-char-up-to-char))
#+end_src
** occur
#+begin_src emacs-lisp
...
#+begin_src emacs-lisp
  (use-package ott-mode
      ...
      :hook
      (ott-mode . smartparens-strict-mode)

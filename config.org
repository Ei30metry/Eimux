...
(setq display-buffer-alist
      '(
        ...
        ;; NOTE I think we I can replace this by saying comint-mode
...
(setq org-capture-templates
     '(("t" "Task")
       ...
       ("ice" "Emacs" entry (file+headline "projects/emacs-config.org" "
       Ideas") "* IDEA %?\n  %i\n")
...
(use-package haskell-mode
  ...
  (:map haskell-mode-map
        ...
        ("C-c h" . hoogle)
        ("C-C C-o" . haskell-interacrtive-bring)
